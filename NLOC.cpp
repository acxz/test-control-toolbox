...
int main(int argc, char** argv)
{
    ...
    std::shared_ptr<ct::optcon::TermQuadratic<state_dim, control_dim>> finalCost(
        new ct::optcon::TermQuadratic<state_dim, control_dim>());
    bool verbose = true;
    intermediateCost->loadConfigFile("nlocCost.info", "intermediateCost", verbose);
    finalCost->loadConfigFile("nlocCost.info", "finalCost", verbose);
    ...
    nloc_settings.load("nlocSolver.info", true, "ilqr");
